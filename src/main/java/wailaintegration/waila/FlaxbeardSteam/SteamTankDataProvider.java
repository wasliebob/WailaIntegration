...
public class SteamTankDataProvider implements IWailaDataProvider{
	@Override
	public List<String> getWailaBody(ItemStack stack, List<String> tt, IWailaDataAccessor da, IWailaConfigHandler ch) {
		 if (da.getTileEntity() instanceof TileEntitySteamTank){
			 TileEntitySteamTank  te = (TileEntitySteamTank ) da.getTileEntity();
